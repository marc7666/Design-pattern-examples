...
public class CompositePattern {
    public static void main(String[] args) {
        ...
        System.out.println("The task " + ct1.getTaskName() + " has a cost of: " + ct1.costInEuros() + " and is: " + ct1.durationInDays() + " days long");
        ct1.printTasks();

        System.out.println("The task " + ct2.getTaskName() + " has a cost of: " + ct2.costInEuros() + " and is: " + ct2.durationInDays() + " days long");
        ct2.printTasks();
